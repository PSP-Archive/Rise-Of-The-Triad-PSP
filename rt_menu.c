...
#if 0
                if ( *number == lowerbound && strcmp(title,"Screen Size")==0) {
            		//deniska rotate brightness values
                    brightness+=10;
                    if (brightness>100)
                        brightness=0;
...
#if 0
        			if ( *number == upperbound && strcmp(title,"Screen Size")==0) {
                		//deniska rotate psp screen sizes
